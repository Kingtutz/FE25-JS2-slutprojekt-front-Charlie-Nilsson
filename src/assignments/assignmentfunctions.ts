import { type NewAssignment, type UpdateAssignmentPayload } from "./assignmenttypes.ts"
...
export const updateAssignment = async(updatePayload: UpdateAssignmentPayload)=>{
  const option={
    method:"PATCH",
